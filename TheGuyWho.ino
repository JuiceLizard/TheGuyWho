...
// Warning! To avoid blinking, please comment the lines of code using arduboy.everyXFrames()
// Lines number 90, 91, 92, 319 and 324.
...
// WARNING! Please comment these three next lines of code if you have epileptic problems
...
// WARNING! Comment these two lines if you have epileptic problem to avoid blinking    

      if(arduboy.everyXFrames(2)){ //comment here
      arduboy.setTextSize(2);
